...
//import java.io.*;
//
//import server.database.PasswordStorage;
//
...
//		ProcessBuilder pb = new ProcessBuilder("php", "tests/phpVerify.php", password, hash);
//
...
//		Process phpTest = null;
//		ProcessBuilder pb = new ProcessBuilder("php", "tests/phpHashMaker.php");
//
//		pb.directory(new File(".."));
//
//		try {
